...
public class AuthControllerTest {
    ...
    private HttpHeaders getHeadersWithCsrf() {
        ...
        ResponseEntity<String> initResponse = restTemplate.getForEntity("http://localhost:" + port + "/api/auth/csrf", String.class);
    ...
    void shouldRegisterAndLoginSuccessfully() {
        ...
        ResponseEntity<String> regResponse = restTemplate.exchange(
            getBaseUrl() + "/register", HttpMethod.POST, registerEntity, String.class);
        ...
        ResponseEntity<String> loginResponse = restTemplate.exchange(
            getBaseUrl() + "/login", HttpMethod.POST, loginEntity, String.class);
        ...
        ResponseEntity<String> meResponse = restTemplate.exchange(
            getBaseUrl() + "/me", HttpMethod.GET, meEntity, String.class);
