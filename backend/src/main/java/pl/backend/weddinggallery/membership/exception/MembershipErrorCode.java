...
public enum MembershipErrorCode implements ErrorCode {
	MEMBERSHIP_NOT_FOUND(HttpStatus.NOT_FOUND, "Membership was not found."),
	MEMBERSHIP_ALREADY_ACTIVE(HttpStatus.CONFLICT, "User is already an active event manager."),
	INVALID_MEMBERSHIP_TARGET(HttpStatus.BAD_REQUEST, "Membership target is invalid."),
