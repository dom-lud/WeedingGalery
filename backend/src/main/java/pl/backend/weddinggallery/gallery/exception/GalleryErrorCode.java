...
public enum GalleryErrorCode implements ErrorCode {
    GALLERY_NOT_FOUND(HttpStatus.NOT_FOUND, "Gallery with the given ID was not found."),
    GALLERY_SLUG_ALREADY_EXISTS(HttpStatus.CONFLICT, "Gallery slug is already taken.");
