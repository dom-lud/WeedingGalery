...
- Stages 7-10: `DONE_FIRST_ITERATION`.
...
| Stage 7-10 E2E contract scenarios | `ADDED_NOT_RUN` | `frontend/tests/e2e/stages-7-10.spec.ts`; requires backend services |

## Checks requiring Docker or a deployed environment

| Check | Status | Required evidence |
| --- | --- | --- |
| MySQL migration and schema compatibility | `CI_REQUIRED` | `MySqlFlywayMigrationContractTest` on a Docker-capable runner |
...
| WCAG and responsive E2E for new screens | `CI_REQUIRED` | Playwright + axe report for Stages 7-10 |
