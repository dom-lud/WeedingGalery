...
| Public upload regressions     | Reguly UX kolejki uploadu i publicznego podgladu mediow | frontend, QA         | przy zmianie publicznej galerii lub uploadu | [docs/frontend/PUBLIC_GALLERY_UPLOAD_REGRESSIONS.md](frontend/PUBLIC_GALLERY_UPLOAD_REGRESSIONS.md) |
...
| Stage 6 test brief              | Macierz ryzyk media processing, jobow, retry i statusow                                  | QA, backend, frontend, security | przy implementacji Etapu 6                                 | [docs/testing/STAGE_6_TEST_BRIEF.md](testing/STAGE_6_TEST_BRIEF.md)                           |
...
| Demo seed test brief            | Ryzyka i weryfikacja migracji Flyway z kontami demo oraz publicznym dostepem            | QA, backend, security, ops      | przy zmianie migracji seeda demo                          | [docs/testing/DEMO_SEED_TEST_BRIEF.md](testing/DEMO_SEED_TEST_BRIEF.md)                       |
| Public upload regression brief  | Regresje publicznego uploadu, retry i podgladu mediow                                  | QA, backend, frontend           | przy zmianie publicznej galerii i uploadu                 | [docs/testing/PUBLIC_GALLERY_UPLOAD_REGRESSION_TEST_BRIEF.md](testing/PUBLIC_GALLERY_UPLOAD_REGRESSION_TEST_BRIEF.md) |
| Media preview/download brief    | Ryzyka podgladu mediow, lightboxa i owner-only ZIP galerii                             | QA, backend, frontend, security | przy zmianie podgladu galerii lub pobierania mediow       | [docs/testing/MEDIA_GALLERY_PREVIEW_DOWNLOAD_TEST_BRIEF.md](testing/MEDIA_GALLERY_PREVIEW_DOWNLOAD_TEST_BRIEF.md) |
...
| Stage 6 readiness checklist  | DoR i granice pierwszego zakresu MEDIA-001                   | autor, reviewer, security, QA  | przed rozpoczeciem implementacji Etapu 6 | [docs/checklists/STAGE_6_READINESS_CHECKLIST.md](checklists/STAGE_6_READINESS_CHECKLIST.md)   |
